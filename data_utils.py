...
def get_wmt_aren_train_set(directory):
  return os.path.join('data', 'train')


def get_wmt_aren_dev_set(directory):
  return os.path.join(directory, 'tune')
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  train_path = get_wmt_aren_train_set(data_dir)
  dev_path = get_wmt_aren_dev_set(data_dir)

  from_train_path = train_path + ".ar"
  to_train_path = train_path + ".en"
  from_dev_path = dev_path + ".ar"
  to_dev_path = dev_path + ".en"
